...
public static void Reflesh()
 {
	 ...
	 Content content = getRandom("GET", "http://www.douyutv.com/member/register/captcha", null, null, false,"d:/");
 ...
 public static String Reg(String code)
 {
	  ...
	  String loginUrl = "http://www.douyutv.com/member/register/ajax";	 
	  Map<String, String> paramMap = new HashMap<String, String>();
	  paramMap.put("email", email);
	  paramMap.put("password", password);
	  paramMap.put("password2", repassword);
	  paramMap.put("nickname",nickname);
	  paramMap.put("captcha_word", validatorImgcode.trim());
	  paramMap.put("redirect", "/");
	  /*System.getProperties().setProperty("http.proxyHost", address);
	  System.getProperties().setProperty("http.proxyPort", port);*/
